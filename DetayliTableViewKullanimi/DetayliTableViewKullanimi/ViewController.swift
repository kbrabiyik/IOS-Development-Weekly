...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let u2 = Urunler(urun_id: 1, urun_ad: "Rayban Club Master", urun_resim_ad: "gozluk", urun_fiyat: 1499.9)
        let u3 = Urunler(urun_id: 1, urun_ad: "Sony ZX Series", urun_resim_ad: "kulaklik", urun_fiyat: 2499.9)
        let u4 = Urunler(urun_id: 1, urun_ad: "Gio Armani", urun_resim_ad: "parfum", urun_fiyat: 1299.9)
        let u5 = Urunler(urun_id: 1, urun_ad: "Casio X Series", urun_resim_ad: "saat", urun_fiyat: 899.9)
        let u6 = Urunler(urun_id: 1, urun_ad: "Dyson V8", urun_resim_ad: "supurge", urun_fiyat: 8899.9)
        let u7 = Urunler(urun_id: 1, urun_ad: "Iphone 13 Pro", urun_resim_ad: "telefon", urun_fiyat: 25999.9)
